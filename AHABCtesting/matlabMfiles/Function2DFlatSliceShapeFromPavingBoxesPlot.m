function [ patchhandle ] = Function2DFlatSliceShapeFromPavingBoxesPlot(inputfile, scale, shift, axeshandle, varargin )
%Read data from inputfile and plot onto axeshandle.

%Function is set up to plot 'flat' 2-D data slice box from a 2-dpaving, to be transformed into a shape, 
