function [ patchhandle ] = Function2DShapeFromPavingBoxesPlot(inputfile, scale, shift, axeshandle, varargin )
%Read data from inputfile and plot onto axeshandle.

%Function is set up for 2-D data from a paving, to be transformed into a shape, 
% ie interval end input (transformed into vertex data here).
%Plots 2-D shape and real range as a 3-d shape
