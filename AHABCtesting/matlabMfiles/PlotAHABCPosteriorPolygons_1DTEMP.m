...
statsfilename = 'AABCsimdata2DGR_ParamsAndStats_s_10_ns_25000_th_0.02_ni_10000.txt';
...
f1 = @Function1DShapeFromPavingBoxesPlot;
f2 = @FunctionGetMaxHeight;
f3 = @FunctionGetXSpread;
f4 = @FunctionGetMeanAndSDFromFile1D;

f = ReadFilenames(filename);
fstats = ReadFilenames(statsfilename);
