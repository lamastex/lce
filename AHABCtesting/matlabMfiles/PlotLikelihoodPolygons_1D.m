% script to plot some 1-d likelihood polygon shapes
% 
...
filename = 'simdata2DGR_LikelihoodPolygons.txt';
...
gifFilename = [outname 'LikelihoodPolygon.gif'];
...
for i=1:size(s1)
    ...
    outputfile = strcat(outname, 'LikelihoodPolygon', int2str(s1(i)), '.png');
