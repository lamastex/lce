...
filename = 'simdata4DGR_SummaryStatMargs2D.txt';

%put the name of the input file for the true param slice summary stat marginals here
filenameTrueParams = 'simdata4DGR_TrueParamSliceSummaryStatMargs2D.txt';
...
for i=1:size(d1)
    ...
    outputfile = strcat(outname, 'SummaryStatMargAndTrueParamsMargSlice',...
