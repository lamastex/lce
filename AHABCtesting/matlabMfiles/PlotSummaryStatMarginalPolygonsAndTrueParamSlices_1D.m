...
filename = 'simdata2DGR_SummaryStatMargPolygons1D.txt';

%put the name of the input file for the true param slice summary stat marginals here
filenameTrueParams = 'simdata2DGR_TrueParamSliceSummaryStatMargPolygons1D.txt';
...
for i=1:size(d1)
    ...
    outputfile = strcat(outname, 'SummaryStatMargAndTrueParamsMargSlicePolygon', int2str(d1(i)), '.png');
