...
/*! \file
\brief Do AABC - RPABC runs using MixtureTest2D.
* 
...
void runAABC_Mixture()
{
	...
	std::string thisDir("HalfAABCMixture4DLargerNewAvSmaller");
				...
				bool doIndividual)
{
	...
	boost::shared_ptr < PopMCabcSimulatorAdaptive > simulatorPtr
							 = doSimulationMixture(
									r_loops,
									n_reps_per_particle*n_obs, // take account of average over n_obs	
									priorLims,
									allRefObjsPtr,
									iterations,
									baseEpsilonPercentile,
