...
/*! \file
\brief Do a number of half AABC and half conditional density runs
*  using a mct::MultiLociSimDataSampler.
* 
...
void runAABC_Simdata()
{
	...
	std::string thisDir("HalfAABCSimData4DSmallNewParamsGPU3"); // need to do larger
	
	std::string descriptionString("HalfAABCsimdata4DGR");
	 ...
	 * epsilon criteria for the first loop, then 0.75 * that */
