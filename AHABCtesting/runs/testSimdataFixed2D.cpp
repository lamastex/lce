...
1 parameter fixed at the true, 1 summary stat.
...
int main()
{
	...
	std::string thisDir("SimData2DFixedTrueParamsTestingTiming");
	
	std::string descriptionString("simdata2DFixed");
	...
	int maxSplits = 10; // max splits to be allowed in rmrp
	...
	cout << "test theta per site " << test_theta_per_site << endl;
