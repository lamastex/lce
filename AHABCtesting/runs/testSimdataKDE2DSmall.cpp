...
{
	int myPid = getpid();
	std::cout << "ahabc with kde function approximation for simdata 2d with small prior range" << std::endl;
	std::cout << "This process id is " << myPid << std::endl;
	
	std::string baseOutputDir("../figures/");
	
	std::string thisDir("SimDataKDE2DSmallNewParams");
	...
	size_t n_reps = 1000; // number of joint observations to generate
