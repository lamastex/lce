...
2 parameters, 2 summary stats, large prior range,
...
int main()
{
	...
	std::string thisDir("SimDataKDE4DNewParams");
	...
	size_t n_reps = 5000; // number of joint observations to generate
	...
	{
		std::vector < double > otherP(1, 3.0*4*Nzero/unit);
		otherP.push_back(60);
		otherParams.push_back(otherP);
	}
	{
