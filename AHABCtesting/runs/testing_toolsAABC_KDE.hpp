...
/*! \file
\brief Tools for doing AABC with KDE

*/

#ifndef _INC_TESTINGTOOLS_AABC_KDE_H
#define _INC_TESTINGTOOLS_AABC_KDE_H
...
void doKDE_AABCSimsMultLociPolytableHeterozygosity(const std::string& prefix,
...
void doKDE_AABCSimsMultLociPolytableHeterozygosityAndSegSites(const std::string& prefix,
				const std::string& spec,
				boost::shared_ptr < mct::PRNGen > r,
				size_t iterations,
				size_t n_obs,
...
void doKDE_AABCSimsMultLociPolytable(const std::string& prefix,
				const std::string& spec,
				boost::shared_ptr < mct::PRNGen > r,
				size_t iterations,
				size_t n_obs,
