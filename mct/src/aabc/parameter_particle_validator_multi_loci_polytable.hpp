...
/*! \file     
\brief ParameterParticleValidatorMultiLociPolyTable declarations.
*/

#ifndef _PARAMETER_PARTICLE_VALIDATOR_MULTI_LOCI_POLYTABLE_H
#define _PARAMETER_PARTICLE_VALIDATOR_MULTI_LOCI_POLYTABLE_H
...
namespace aabc {
	...
	/** @brief A class capable of 
	 ...
	 A ParameterParticleValidatorMultiLociPolyTable
	 will have access to a reference mct::MultiLociPolyTable and
	 will be able to take a ParameterParticle and use it to a
	 calculate a mct::SummaryStatistic for that particle.
	 
	 A ParameterParticleValidatorMultiLociPolyTable is configured with a 
	 ...
	 a mct::SummaryStatistic for the particle.
	...
	class ParameterParticleValidatorMultiLociPolyTable 
		...
		public:
			...
			ParameterParticleValidatorMultiLociPolyTable(
			...
			virtual ~ParameterParticleValidatorMultiLociPolyTable();
