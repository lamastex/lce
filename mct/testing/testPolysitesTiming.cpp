...
/*! \file
\brief Timing test with polysites sampler.
...
// timing test for polysites
void polysitesTimingTest()
{
	try {
		int myPid = getpid();
		std::cout << "timing testing  for polysites " << std::endl;
